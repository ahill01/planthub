...
function PlantSummary({plant, setUserPlants, editPlant, setEditPlant}){
const [displaySummary, setDisplaySummary]=useState(true)
    ...
    <div className="plantInfo">
        <div className={plant.thirsty ? "summary thirsty": "summary notThirsty"}>
            ...
            {displaySummary ? <br></br> : (<PlantDetails key={plant.id} plant={plant} setUserPlants={setUserPlants} editPlant={editPlant} setEditPlant={setEditPlant} />)} 
        </div>
    </div>
    )
}
